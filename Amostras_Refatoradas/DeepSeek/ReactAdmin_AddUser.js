...
async function uploadToServer(file, path, filename) {
...
function Step0Form({ newUser, handleChange }) {
  return (
    <>
      <TextField
        id="outlined-basic"
...
function Step1Form({ newUser, handleChange, classes, fileInput, handleFile, deleteOneImage }) {
  return (
    <>
...
function Step2Form({ handleChange }) {
  return (
    <>
      <TextField
        id="outlined-basic"
...
function Step3Form({ handleChange }) {
  return (
    <>
      <TextField
        id="outlined-basic"
...
function StepNavigation({ activeStep, stepsLength, handleBack, handleNext }) {
  if (activeStep === 0) {
    return (
        ...
        <Widget>
          <Grid justify="center" container>
            <Box display="flex" flexDirection="column" width={600}>
              ...
              {activeStep === 0 && <Step0Form newUser={newUser} handleChange={handleChange} />}
              {activeStep === 1 && (
                <Step1Form
                  newUser={newUser}
              ...
              {activeStep === 2 && <Step2Form handleChange={handleChange} />}
              {activeStep === 3 && <Step3Form handleChange={handleChange} />}
