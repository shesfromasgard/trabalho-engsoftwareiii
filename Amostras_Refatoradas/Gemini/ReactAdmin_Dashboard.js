...
function Dashboard() {
  ...
  const mainChartData = useMemo(() => {
    ...
    return tablet.map((item, index) => ({
      tablet: item.value,
      desktop: desktop[index]?.value,
  ...
  return (
    <Grid container spacing={3}>
      <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
        <Widget title="Support Tracker" bodyClass={classes.fullHeightBody} className={classes.card}>
          ...
          <Grid container direction="row" justify="space-between" alignItems="center" wrap="nowrap">
            <Grid>
              <Typography color="text" colorBrightness="hint" variant="caption" style={{ marginRight: 5 }} noWrap>
                New Tickets
              </Typography>
            ...
            <Grid>
              <Typography color="text" colorBrightness="hint" variant="caption" style={{ marginRight: 5 }}>
                Open
              </Typography>
              <Box display="flex" alignItems="center" justifyContent="center">
                <Typography size="md" weight="medium" style={{ marginRight: 8 }}>
      ...
      <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
        <Widget title="Revenue Breakdown" className={classes.card} bodyClass={classes.alignStandaloneElement}>
          <Grid container spacing={3}>
            <Grid
              style={{
                display: "flex",
              ...
              <div className={classes.pieChartLegendWrapper}>
                {PieChartData.map(({ name, value, color }) => (
                  <div key={color} className={classes.legendItemContainer}>
                    ...
                    <Typography color="text" colorBrightness="hint" variant="caption" noWrap>
                      &nbsp;{name}&nbsp;
                    </Typography>
        ...
        <Widget title="App Performance" className={classes.card} bodyClass={classes.fullHeightBody}>
          <div className={classes.performanceLegendWrapper}>
            <div className={classes.legendElement}>
              <Dot color="warning" />
              <Typography color="text" colorBrightness="hint" variant="body2" className={classes.legendElementText}>
                Integration
              </Typography>
            </div>
            <div className={classes.legendElement}>
            ...
            <div className={classes.mainChartHeader}>
              ...
              <div className={classes.mainChartHeaderLabels}>
                <div className={classes.mainChartHeaderLabel}>
                  <Dot color="warning" />
                  <Typography className={classes.mainChartLegendElement}>Tablet</Typography>
                </div>
                <div className={classes.mainChartHeaderLabel}>
                  <Dot color="primary" />
                  <Typography className={classes.mainChartLegendElement}>Mobile</Typography>
                </div>
                <div className={classes.mainChartHeaderLabel}>
                  <Dot color="secondary" />
                  <Typography className={classes.mainChartLegendElement}>Desktop</Typography>
                </div>
              </div>
              <Select
                      ...
                      >
                        ...
                        <TableCell>
                          <Box display="flex" flexWrap="nowrap" alignItems="center">
                            <Avatar alt={row.customer} color={row.color} style={{ marginRight: 8 }}>
                              {row.customer[0]}
                            </Avatar>
                            <Typography style={{ whiteSpace: "nowrap" }}>{row.customer}</Typography>
                          </Box>
                        </TableCell>
